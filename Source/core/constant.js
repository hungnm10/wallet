...
global.CONST_NAME_ARR = ["WATCHDOG_DEV", "AUTO_COORECT_TIME", "DELTA_CURRENT_TIME", "COMMON_KEY", "NODES_NAME", "SERVER_PRIVATE_KEY_HEX",
"USE_NET_FOR_SERVER_ADDRES", "NET_WORK_MODE", "STAT_MODE", "MAX_STAT_PERIOD", "UPDATE_NUM_COMPLETE", "HTTP_IP_CONNECT", "HTTP_PORT_NUMBER",
"HTTP_PORT_PASSWORD", "WALLET_NAME", "WALLET_DESCRIPTION", "COUNT_VIEW_ROWS", "ADDRLIST_MODE", "CheckPointDelta", "USE_MINING",
"POW_MAX_PERCENT", "ALL_LOG_TO_CLIENT", "LIMIT_SEND_TRAFIC", "MAX_WNUM", "MIN_VER_STAT", "STOPGETBLOCK", "RESTART_PERIOD_SEC",
"HARD_PACKET_PERIOD120", "MINING_START_TIME", "MINING_PERIOD_TIME", "TRANSACTION_PROOF_COUNT", "USE_AUTO_UPDATE", "DEBUG_WALLET",
"COUNT_MINING_CPU", "SIZE_MINING_MEMORY", "MAX_GRAY_CONNECTIONS_TO_SERVER", "POW_RUN_COUNT_FIND", "POW_RUN_COUNT", "HTTP_HOSTING_PORT",
"USE_HINT", "ALL_VIEW_ROWS", "WATCHDOG_BADACCOUNT", ];
