...
if(global.TEST_NETWORK)
{
    FindList=[
        ...
        {"ip":"194.1.239.210","port":40000},
        {"ip":"194.1.237.94","port":40000},
        {"ip":"91.235.136.150","port":40000},

        {"ip":"185.244.173.211","port":40000},
        {"ip":"185.244.173.220","port":40000},
    ];
}
...
function RunOnUpdate()
{
    ...
    if(CurNum!==UPDATE_CODE_VERSION_NUM)
    {
        ...
        else
        {
            ...
            CheckRewriteTr(3950000,"D9A22AF7384E3B1BA9236A8D86D153EDA635A9BB680E57C9B15A4AE5DD501F5F",3880000);
            CheckRewriteTr(3980000,"E078512F87495F9D871C0362B3854EBFB7E06152BBB6B3F4D516699C0A2BFB58",3950000);
